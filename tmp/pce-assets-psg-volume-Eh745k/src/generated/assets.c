...
static const pce_editor_psg_step_t pce_editor_psg_half_pattern[] PCE_EDITOR_RODATA_SECTION = {
  { 0u, 0u, 512u, 10u, 0u, 0u },
  { 1u, 0u, 256u, 15u, 0u, 0u }
};
...
const pce_editor_psg_asset_t pce_editor_psg_assets[] PCE_EDITOR_RODATA_SECTION = {
  { 0u, 512u, 150u, 4u, pce_editor_psg_half_pattern, 2u, (const pce_editor_cd_data_ref_t *)0 }
};
