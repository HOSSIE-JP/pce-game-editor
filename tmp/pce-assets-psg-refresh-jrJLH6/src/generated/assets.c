...
static const pce_editor_psg_step_t pce_editor_psg_song_pattern[] PCE_EDITOR_RODATA_SECTION = {
  { 0u, 0u, 254u, 24u, 0u, 0u },
  { 4u, 0u, 1u, 0u, 0u, 0u }
};
...
const pce_editor_psg_asset_t pce_editor_psg_assets[] PCE_EDITOR_RODATA_SECTION = {
  { 1u, 254u, 120u, 5u, pce_editor_psg_song_pattern, 2u, (const pce_editor_cd_data_ref_t *)0 }
};
const unsigned int pce_editor_psg_asset_count PCE_EDITOR_RODATA_SECTION = 1;
...
const unsigned int pce_editor_tone_period PCE_EDITOR_RODATA_SECTION = 254;
