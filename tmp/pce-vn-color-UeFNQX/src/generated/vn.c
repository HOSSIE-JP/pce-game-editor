...
const pce_vn_cd_data_ref_t PCE_VN_DATA_SECTION pce_vn_visual_code_data = { { 0u, 0u, 0u }, 0u, 0u };
#else
const unsigned char PCE_VN_FONT_SECTION pce_vn_font_tiles[] = {
  ...
  0x00, 0x18, 0xc0, 0x18, 0x40, 0x7f, 0x60, 0x13, 0x20, 0x11, 0x30, 0x31, 0x00, 0x31,
  0x00, 0x23, 0x00, 0x63, 0x00, 0x4e, 0x00, 0x00
};
#endif
