...
const pce_editor_meta_region_t pce_editor_psg_meta PCE_EDITOR_RODATA_SECTION = { { 73u, 0u, 0u }, 0u };
const pce_editor_meta_region_t pce_editor_cdda_meta PCE_EDITOR_RODATA_SECTION = { { 73u, 0u, 0u }, 2u };
...
const unsigned int pce_editor_cdda_asset_count PCE_EDITOR_RODATA_SECTION = 2;
