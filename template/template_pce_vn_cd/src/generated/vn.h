...
#define PCE_VN_COMMAND_SPRITE_MOVE 16u
#define PCE_VN_SPRITE_MOVE_ASYNC 1u
...
#define PCE_VN_CACHE_SCOPE_PSG 4u
#define PCE_VN_CACHE_SCOPE_ALL 5u
...
#define PCE_VN_FONT_SPRITE_PATTERN_BASE 462u
#define PCE_VN_FONT_SPRITE_PALETTE_BANK 15u
#define PCE_VN_SPRITE_PATTERN_BASE 590u
