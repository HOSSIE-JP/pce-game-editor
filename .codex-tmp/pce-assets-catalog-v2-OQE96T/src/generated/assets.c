...
const pce_editor_meta_region_t pce_editor_adpcm_meta PCE_EDITOR_RODATA_SECTION = { { 65u, 0u, 0u }, 0u };
const pce_editor_meta_region_t pce_editor_psg_meta PCE_EDITOR_RODATA_SECTION = { { 65u, 0u, 0u }, 1u };
const pce_editor_meta_region_t pce_editor_cdda_meta PCE_EDITOR_RODATA_SECTION = { { 66u, 0u, 0u }, 1u };
