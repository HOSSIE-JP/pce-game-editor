...
#if defined(__PCE_CD__)
static const pce_editor_cd_data_ref_t pce_editor_psg_song_pattern_cd PCE_EDITOR_CD_REF_SECTION = { { 64u, 0u, 0u }, 6u, 10400u, 0u };
#endif
static const pce_editor_psg_step_t pce_editor_psg_blip_pattern[] PCE_EDITOR_RODATA_SECTION = {
...
const pce_editor_psg_asset_t pce_editor_psg_assets[] PCE_EDITOR_RODATA_SECTION = {
  { 1u, 256u, 120u, 360u, (const pce_editor_psg_step_t *)0, 1300u, &pce_editor_psg_song_pattern_cd },
  { 0u, 512u, 150u, 4u, pce_editor_psg_blip_pattern, 1u, (const pce_editor_cd_data_ref_t *)0 }
};
const unsigned char pce_editor_psg_asset_count PCE_EDITOR_RODATA_SECTION = 2;
...
const unsigned int pce_editor_tone_period PCE_EDITOR_RODATA_SECTION = 256;
