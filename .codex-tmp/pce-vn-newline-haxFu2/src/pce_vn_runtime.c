...
static uint8_t ensure_sprite_patterns_loaded(uint8_t slot_index, uint16_t sprite_index, const pce_editor_data_ref_t *patterns, uint16_t pattern_base, uint16_t pattern_units)
{
