...
const pce_editor_meta_region_t pce_editor_bg_meta PCE_EDITOR_RODATA_SECTION = { { 68u, 0u, 0u }, 512u };
const pce_editor_meta_region_t pce_editor_sprite_meta PCE_EDITOR_RODATA_SECTION = { { 100u, 0u, 0u }, 512u };
const pce_editor_meta_region_t pce_editor_adpcm_meta PCE_EDITOR_RODATA_SECTION = { { 228u, 0u, 0u }, 512u };
const pce_editor_meta_region_t pce_editor_psg_meta PCE_EDITOR_RODATA_SECTION = { { 236u, 0u, 0u }, 512u };
const pce_editor_meta_region_t pce_editor_cdda_meta PCE_EDITOR_RODATA_SECTION = { { 244u, 0u, 0u }, 0u };

const unsigned int pce_editor_bg_asset_count PCE_EDITOR_RODATA_SECTION = 512;
const unsigned int pce_editor_sprite_asset_count PCE_EDITOR_RODATA_SECTION = 512;
const unsigned int pce_editor_adpcm_asset_count PCE_EDITOR_RODATA_SECTION = 512;
const unsigned int pce_editor_psg_asset_count PCE_EDITOR_RODATA_SECTION = 512;
