...
#if defined(__PCE_CD__)
const pce_vn_cd_data_ref_t PCE_VN_DATA_SECTION pce_vn_font_data = { { 64u, 0u, 0u }, 1u, 72u };
...
const unsigned char PCE_VN_FONT_SECTION pce_vn_font_tiles[] = {
  ...
  0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x0e,
  0x00, 0x0f, 0x00, 0x1b, 0x00, 0x19, 0x80, 0x1f, 0x80, 0x31, 0xc0, 0x30, 0x00, 0x00,
  0x00, 0x00
};
#endif
const unsigned int PCE_VN_DATA_SECTION pce_vn_font_glyph_count = 3u;
