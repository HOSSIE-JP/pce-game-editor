...
const COMMANDS = [
  ...
  { name: 'asset_list', description: 'List assets from assets/pce-assets.json.', inputSchema: objectSchema() },
  { name: 'asset_upsert', description: 'Insert or replace one PCE asset by id.', mutates: true, inputSchema: objectSchema({ asset: { type: 'object' } }, ['asset']) },
  { name: 'asset_delete', description: 'Delete one PCE asset by id.', mutates: true, destructive: true, inputSchema: objectSchema({ id: { type: 'string' } }, ['id']) },
